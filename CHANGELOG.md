...
### Changed
- **CGA Network Format**: Removed unused `position` field (x, y, z) from published data
  - Position data is stored in `latLonAlt` field
  - Reduces payload size by removing redundant zero-value fields
